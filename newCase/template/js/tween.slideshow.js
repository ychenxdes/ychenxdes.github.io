    ...
    $.fn.slideshow = function (options) {
        ...
        main = {
            ...
            setNav: function () {
                ...
                for (i = 0; i < main.param.total; i+=1) {
                    ...
                    _nav[i] = (settings.isNumber) ?
                        '<a href="javascript:void(0)"' + active + '>' + (i + 1) + '</a>' :
            ...
            setControl: function () {
                var $control,
                    html = '<div id="js-ele-slideshow-control' + settings.uni + '" class="ele-slideshow-control">'
                         + '<a href="javascript:void(0)" id="js-ele-slideshow-start' + settings.uni + '" class="ele-slideshow-start"></a>'
                         + '<a href="javascript:void(0)" id="js-ele-slideshow-stop' + settings.uni + '" class="ele-slideshow-stop">'
            ...
            setArrow: function () {
                ...
                html = '<a href="javascript:void(0)" id="js-ele-slideshow-arrow-left' + settings.uni + '" '
                     + 'class="ele-slideshow-arrow ele-slideshow-arrow-left"><i></i></a>'
                     + '<a href="javascript:void(0)" id="js-ele-slideshow-arrow-right' + settings.uni + '" '
        ...
        $.getScript('../template/js/slideshow/plugin_' + settings.animationType + '.js', function () {
            $(function() {
                main.init();
            });
        });
